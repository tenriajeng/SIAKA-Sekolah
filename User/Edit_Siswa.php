...
if ($_SESSION['login_user'] == '')
    ...
    $kd = $_GET['id'];
    $sql = "SELECT nis, nama, alamat, tmp_lahir FROM siswa WHERE kd_siswa = $kd";
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                ...
                                <form method="POST" action="PEdit_Siswa.php" enctype="multipart/form-data">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">NIS </label>
                                        <div class="col-sm-10">
                                            <input type="text" required value="<?=$nis?>" name="NIS" class="form-control" placeholder="NIS">
                                        </div>
                                    </div>
                                    <div class="form-group row">
