                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="mapel" class="form-control">
                                                ...
                                                <?php
                                                $sql = "SELECT nm_semester FROM semester ORDER BY nm_semester ASC";
                                                $result = mysqli_query($db,$sql);
                                                while($row=mysqli_fetch_array($result)){?>
                                                    <option value="<?php echo $row['nm_semester'];?>"><?php echo $row['nm_semester'];?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="mapel" class="form-control">
                                                ...
                                                <?php
                                                $sql = "SELECT nama_mapel FROM mapel ORDER BY nama_mapel ASC";
                                                $result = mysqli_query($db,$sql);
                                                while($row=mysqli_fetch_array($result)){?>
