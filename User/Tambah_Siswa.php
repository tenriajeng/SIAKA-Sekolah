                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                ...
                                <form method="POST" action="PTambah_Siswa.php" enctype="multipart/form-data">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">NIS </label>
                                        <div class="col-sm-10">
                                            <input type="text" required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')" name="NIS" class="form-control" placeholder="NIS">
                                        </div>
                                    </div>
                                    <div class="form-group row">
