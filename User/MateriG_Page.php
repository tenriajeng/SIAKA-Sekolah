...
if (isset($_GET['id'])) {
	$kd = $_GET['id'];
	$sql = "DELETE FROM materi WHERE kd_materi = $kd";
                    ...
                    <div class="card-block table-border-style">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <?php
                                    $sql = "SELECT materi.Pupload,mapel.nama_mapel,materi.kd_materi,materi.nama_materi,materi.nama_file,guru_mapel.kd_guru FROM guru_mapel 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href='EditM_Page.php?id=<?php echo $row['kd_materi'];?>'>
                                                <button class="btn btn-warning btn-outline-warning">
                                                    <i class="icofont icofont-ui-edit"></i>Edit
                                                </button>
                                            </a>
                                            <a href="MateriG_Page.php?id=<?php echo $row['kd_materi'];?>">
