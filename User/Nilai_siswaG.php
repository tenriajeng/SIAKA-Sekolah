    ...
    <div class="main-body">
        <div class="page-wrapper">
            ...
            <div class="page-body">
                ...
                <?php
                    $smt = "SELECT MAX(nilai_siswa.kd_semester),kelas.nama_kelas,kelas.kd_kelas 
                    FROM nilai_siswa 
                    INNER JOIN siswa ON siswa.kd_siswa = nilai_siswa.kd_siswa
                    INNER JOIN kelas ON kelas.kd_kelas = siswa.kd_kelas WHERE siswa.kd_kelas = $kdk
                    ";
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <?php
                                            $sql = "SELECT kd_siswa,nis,nama,alamat,jns_kelamin FROM siswa WHERE kd_kelas = $kdk ";
