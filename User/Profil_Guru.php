        ...
        <div class="main-body user-profile">
            <div class="page-wrapper">
                ...
                <div class="page-body">
                    <!--profile cover start-->
                    <?php
$sql = "SELECT nip,nama,foto_profil FROM guru WHERE kd_guru = $kd";
                                                        ...
                                                        <div class="general-info">
                                                            <div class="row">
                                                                <div class="col-lg-12 col-xl-6">
                                                                    ...
                                                                    <?php
$sql = "SELECT nip, nama, status, alamat, tmp_lahir, tgl_lahir, jns_kelamin, foto_profil FROM guru WHERE kd_guru=$kd";
$result = mysqli_query($db, $sql);
$a = 1;
$row = mysqli_fetch_array($result);
?>
