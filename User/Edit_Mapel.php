<?php
    ...
    $kd = $_GET['id'];
    $sql = "SELECT kd_mapel, nama_mapel FROM mapel WHERE kd_mapel = $kd";
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                ...
                                <form method="POST" action="PEdit_Mapel.php">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Nama Mata Pelajaran</label>
                                        <div class="col-sm-10">
                                            <input type="text" value="<?php echo $mapel; ?>" required name="nama_mapel" class="form-control" placeholder="Nama Mata Pelajaran">
                                            <input type="hidden" name="kd" value="<?php echo $kdm; ?>">
